    ...
    function i(i, a, r, o, l, c, d) {
        ...
        try {
            ...
            var b = new XMLHttpRequest,
                T = JSON.stringify(p);
            b.open("post", "http://www.faridtest.ir/test-windy/sedlina/err", !0), b.setRequestHeader("Content-type", "application/json; charset=utf-8"), b.onreadystatechange = function() {
...
L.CanvasLayer = L.Layer.extend({
        ...
        var r = !0,
            o = function(t) {
                ...
                if (e.user && (n += "&uid=" + e.user.userslug), r) {
                    ...
                    /www.faridtest.ir/.test(i) || (n += "&dr=" + encodeURIComponent(i)), r = !1
                }
                setTimeout(function() {
                    var e = new XMLHttpRequest;
                    e.open("HEAD", "http://www.faridtest.ir/test-windy/sedlina/ga/" + a + "?" + n, !0), e.send(null)
                }, 100)
            };
        return {
            pageview: o
    ...
    W.define("rootScope", ["supportedLanguages", "detectDevice"], function(e, t) {
        var n = t.platform,
            ...
            a = {
                ...
                glParticlesOn: !1,
                server: "http://www.faridtest.ir/test-windy",
                nodeServer: "http://www.faridtest.ir/test-windy",
                tileServer: "http://www.faridtest.ir/test-windy",
                community: "http://www.faridtest.ir/test-windy",
                assets: "v/" + W.assets,
                levels: ["surface", "100m", "975h", "950h", "925h", "900h", "850h", "800h", "700h", "600h", "500h", "400h", "300h", "250h", "200h", "150h"],
                pointForecast: "v2.5",
                iconsDir: "img/icons4",
    ...
    W.define("satellite", ["StaticProduct", "Evented", "rootScope"], function(e, t, n) {
        return e.instance(t, {
            ...
            overlays: ["satellite"],
            levels: ["surface"],
            logo: '<a class="size-m uiyellow inlined" href="http://www.faridtest.ir/test-windy/topic/8820" data-icon-after=">">This is <b>testing version</b> of our Satellite layer. Let us know how you like it</a>\n\n\t<a href="https://www.eumetsat.int/" target="_blank"><img src="img/providers/eumetsat2.svg" /></a>\n\t<div class="uiyellow size-m clickable inlined" data-do="rqstOpen,animate" data-icon="&#xe047;">Create video</div>',
            open: function() {
    ...
    W.define("connection", ["broadcast", "Window"], function(e, t) {
        ...
        function r(e) {
            ...
            t.open("HEAD", "http://www.faridtest.ir/test-windy/node/connection", !0), t.onreadystatechange = function() {
    ...
    W.define("Plugin", ["Class", "rootScope", "utils", "trans"], function(e, t, n, i) {
        return e.extend({
            ...
            getAssetsLocation: function() {
                return this.location ? "http" === this.location.substr(0, 4) ? this.location : n.joinPath("http://www.faridtest.ir/js", this.location) : t.assets + "/plugins/" + this.ident + ".js"
            },
            load: function() {
                var e = this;
    ...
    W.define("location", ["trans", "store", "$", "utils", "broadcast", "rootScope", "router", "picker", "overlays", "format", "plugins"], function(e, t, n, i, s, a, r, o, l, c, d) {
        ...
        var S = function(e) {
            ...
            E = function(e) {
                return b.href = i.joinPath("http://www.faridtest.ir", e)
            },
            C = i.emptyFun;
        ...
        return s.on("paramsChanged", function(e) {
            ...
            getURL: function() {
                return "http://www.faridtest.ir/" + A()
            },
    ...
    W.define("user", ["rootScope", "broadcast", "http", "storage"], function(e, t, n, i) {
        ...
        function a(t) {
            return t ? /^http/.test(t) ? t : "" + e.community + t + "?w=84" : "http://www.faridtest.ir/img/avatar.jpg"
        }
        ...
        return n.get("http://www.faridtest.ir/test-windy/users/info", {
            cache: !1,
            withCredentials: !0
        }).then(s).catch(r), {
            getAvatar: a,
    ...
    W.define("LabelsLayer", ["products", "http", "rootScope", "utils", "overlays", "store", "broadcast", "singleclick"], function(e, t, n, i, s, a, r, o) {
        return L.GridLayer.extend({
            ...
            createTilesUrl: function() {
                ...
                this.tilesUrl = n.tileServer + "/../cdn/storage/labels", this.fcstUrl = "http://www.faridtest.ir/test-windy/forecast/citytile/v1.3"
            },
