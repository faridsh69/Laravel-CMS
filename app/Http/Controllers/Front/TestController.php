...
class TestController extends Controller
{
    ...
    public function getAccessToken()
    {
        ...
        $ch_token = curl_init();
        curl_setopt($ch_token, CURLOPT_URL, $this->token_url);
        curl_setopt($ch_token, CURLOPT_POST, 1);
        curl_setopt($ch_token, CURLOPT_POSTFIELDS, $access_token_body_urlencode);
        curl_setopt($ch_token, CURLOPT_RETURNTRANSFER, true);
        $server_output_token = curl_exec($ch_token);
        curl_close ($ch_token);
        $access_token = json_decode($server_output_token)->access_token;
    ...
    {
        $data_full = 'data:image/jpeg;base64,';
