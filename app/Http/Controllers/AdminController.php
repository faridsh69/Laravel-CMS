...
class AdminController extends Controller
{
    ...
    { 
        $meta = [
            'title' => __($this->model . ' Manager'),
            'description' => __('Admin Panel Page For Best Cms In The World'),
            'image' => \Cdn::asset('upload/images/logo.png'),
            'alert' => 'This is a table of '.$this->model.' with sort and filter and paginate.',
            'link_route' => route('admin.'.$this->model.'.list.create'),
            'link_name' => __('Create New '.$this->model),
        ];

        return view('admin.list.table', compact('meta'));
    }
