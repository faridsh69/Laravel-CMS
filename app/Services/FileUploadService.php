...
class FileUploadService extends BaseService
{
	public function save($file, $model, $title = null)
	{
        ...
        // save file
        $upload_path = storage_path('app/public/' . $class_name . '/' . $imageable_id . '/' . $field_type . '.' . 'jpg');
        dd($upload_path);
        // File::save()
        // storage/app/public/files/product/id/input_title . file type
        ...
        dd($mime_type, $imageable_type, $imageable_id, $size);
