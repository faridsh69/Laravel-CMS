...
//            }
      ...
      $(document).on('click', '.rm_gallery_file', function () {
        ...
        if (file_id != 0) {
            // @todo admin.removeItemGalleryFile
