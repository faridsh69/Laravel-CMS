	...
	<div class="m-stack m-stack--ver m-stack--general">
		...
		<div class="m-stack__item m-stack__item--middle m-brand__logo">
			<a href="javascript:void(0)" class="m-brand__logo-wrapper">
				<img alt="admin-logo" style="max-height: 60px;" src="{{ asset(config('0-general.logo')) }}"/>
			</a>
		</div>
		<div class="m-stack__item m-stack__item--middle m-brand__tools">
			...
			<a id="m_aside_header_menu_mobile_toggle" href="javascript:void(0)" class="m-brand__icon m-brand__toggler m--visible-tablet-and-mobile-inline-block">
				<span></span>
			</a>
			<!-- END -->
