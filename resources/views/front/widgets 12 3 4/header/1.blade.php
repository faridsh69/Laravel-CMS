	...
	<ol class="slides">
		<li class="current">
			<div class="description">
				<h2 class="text-right rtl"> Title</h2>
				<div class="seperate"></div>
				<p class="text-right rtl">desc </p>
			</div>
			<div class="tiltview row">
				<a href="#"><img src="{{ asset('images/module/3_mobile.jpg') }}"/></a>
				<a href="#"><img src="{{ asset('images/module/4_mobile.jpg') }}"/></a>
			</div>
		</li>
	</ol>
</div>
