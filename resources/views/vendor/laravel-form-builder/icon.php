...
<?php if ($showField): ?>
    <select class="form-control m-bootstrap-select m-bootstrap-select--pill m-bootstrap-select--air m_selectpicker" data-live-search="true" id="<?php echo $name ?>" name="<?php echo $name ?>">
    	<?php foreach($icons_array as $icon_key => $icon_item): ?>
    		<option data-icon="fa <?php echo $icon_key ?>"><?php echo $icon_key ?></option>
		<?php endforeach ?>
	</select>
