...
class EricSettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $general_settings = [
			...
			'default_meta_image' => 'http://www.synergypower.ir/cdn/storage/photos/shares/image001.png',
			'default_user_image' => 'http://www.synergypower.ir/cdn/css/front/capp/img/bg-img/user1.ico',
			...
			'introduce_video_url' => 'http://www.synergypower.ir/cdn/css/front/capp/img/ericsynergypower.mp4',
			'introduce_video_cover_photo' => 'http://www.synergypower.ir/cdn/css/front/capp/img/eric/team.jpg',
        ...
        $developer_settings = [
			...
			'app_env' => '1',
			'theme' => 'capp',
			'cdn_url' => 'http://www.synergypower.ir/cdn',
			'throttle' => '15,0.2',
			'lazy_loading' => '1',
